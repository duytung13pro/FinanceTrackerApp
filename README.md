...
<img src="https://github.com/duytung13pro/FinanceTrackerApp/blob/main/Fintech/assets/images/cloud.png" width="30%" style="position: relative; top: 0; right: 0;" alt="Project Logo"/>
...
<img src="https://img.shields.io/badge/Unlicense-808080.svg?style=flat-square&logo=Unlicense&logoColor=white" alt="Unlicense">
<img src="https://img.shields.io/badge/Lefthook-FF1E1E.svg?style=flat-square&logo=Lefthook&logoColor=white" alt="Lefthook">
...
<br>
<img src="https://img.shields.io/badge/Glide-18BED4.svg?style=flat-square&logo=Glide&logoColor=white" alt="Glide">
<img src="https://img.shields.io/badge/Gradle-02303A.svg?style=flat-square&logo=Gradle&logoColor=white" alt="Gradle">
<img src="https://img.shields.io/badge/GitBook-BBDDE5.svg?style=flat-square&logo=GitBook&logoColor=black" alt="GitBook">
...
<img src="https://img.shields.io/badge/Hermes-0091CD.svg?style=flat-square&logo=Hermes&logoColor=white" alt="Hermes">
...
<img src="https://img.shields.io/badge/Facebook-0866FF.svg?style=flat-square&logo=Facebook&logoColor=white" alt="Facebook">
...
<img src="https://img.shields.io/badge/Doxygen-2C4AA8.svg?style=flat-square&logo=Doxygen&logoColor=white" alt="Doxygen">
...
<img src="https://img.shields.io/badge/Appium-EE376D.svg?style=flat-square&logo=Appium&logoColor=white" alt="Appium">
...
- **Package Manager:** Npm, Yarn, Bower, Gradle, Cmake, Nuget
- **Container Runtime:** Docker

### Installation

Build FinanceTrackerApp from the source and intsall dependencies:

1. **Clone the repository:**

    ```sh
    ❯ git clone ../FinanceTrackerApp
    ```
...
<!-- SHIELDS BADGE CURRENTLY DISABLED -->
	...
	**Using [docker](https://www.docker.com/):**
	...
	```sh
	❯ docker build -t GitHub/FinanceTrackerApp .
	```
<!-- SHIELDS BADGE CURRENTLY DISABLED -->
...
Financetrackerapp uses the {__test_framework__} test framework. Run the test suite with:
...
- **💬 [Join the Discussions](https://LOCAL/GitHub/FinanceTrackerApp/discussions)**: Share your insights, provide feedback, or ask questions.
- **🐛 [Report Issues](https://LOCAL/GitHub/FinanceTrackerApp/issues)**: Submit bugs found or log feature requests for the `FinanceTrackerApp` project.
- **💡 [Submit Pull Requests](https://LOCAL/GitHub/FinanceTrackerApp/blob/main/CONTRIBUTING.md)**: Review open PRs, and submit your own PRs.
...
2. **Clone Locally**: Clone the forked repository to your local machine using a git client.
   ```sh
   git clone C:\Users\caomi\GitHub\FinanceTrackerApp
   ```
...
<br>
<p align="left">
   <a href="https://LOCAL{/GitHub/FinanceTrackerApp/}graphs/contributors">
      <img src="https://contrib.rocks/image?repo=GitHub/FinanceTrackerApp">
   </a>
</p>
</details>
...
Financetrackerapp is protected under the [LICENSE](https://choosealicense.com/licenses) License. For more details, refer to the [LICENSE](https://choosealicense.com/licenses/) file.
